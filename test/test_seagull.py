...
def mock_imports(monkeypatch):
    ...
    monkeypatch.setattr("PyGRidge.src.lambda_max_sparse_group_lasso.lambda_max_sparse_group_lasso", mock_lambda_max)
    ...
    monkeypatch.setattr("PyGRidge.src.sparse_group_lasso.sparse_group_lasso", mock_sparse_group_lasso)
...
def test_mismatching_dimensions_y_Z():
    with pytest.raises(ValueError, match="Mismatching dimensions of vector y and matrix Z"):
